...
import nl.marisabel.transactions.interfaces.UploadFileRepository;
...
public class TransactionsCSVReaderING {
 ...
 public TransactionsCSVReaderING(TransactionRepository transactionRepository, AutoCategoryRepository autoCategoryRepository, UploadFileRepository uploadFileRepository, TransactionUploadResult result) {
 ...
 public TransactionUploadResult read(InputStream file) throws Exception {
  ...
  int totalTransaction = nonDuplicateCount + duplicateCount;
  UploadFileEntity uploadFileEntity = new UploadFileEntity();
  uploadFileEntity.setFileName(file.toString());
  uploadFileEntity.setSignatureDate(LocalDate.now());
  uploadFileEntity.setNumberOfTransactions(totalTransaction);
